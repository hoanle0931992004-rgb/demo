# ĐẶC TẢ USE CASE - HỆ THỐNG THU GOM RÁC TÁI CHẾ THÔNG MINH
...
| - | 3. Kiểm tra tính hợp lệ của dữ liệu và email chưa tồn tại. |
...
| - | 3. Kiểm tra thông tin đăng nhập có tồn tại và chính xác. |
| - | 4. Kiểm tra tài khoản chưa bị khóa. |
| - | 5. Tạo phiên đăng nhập và chuyển hướng đến trang chủ theo vai trò. |
| - | 6. Kết thúc Use case. |
...
**Điều kiện sau:** Người dùng đã đăng nhập thành công, có phiên làm việc và quyền truy cập theo vai trò.
...
- **Mô tả chung:** Mô tả việc khách hàng xem thông tin tài khoản, chỉnh sửa thông tin hoặc thay đổi mật khẩu.
...
**Luồng thay thế:** Luồng 5a – Không tải ảnh: Khách hàng nhập thủ công loại rác. Luồng 7a – Thiếu thông tin bắt buộc: Hiển thị lỗi, yêu cầu bổ sung.
...
**Tác nhân, mô tả chung:**
- **Tác nhân:** Khách hàng (Customer).
- **Mô tả chung:** Mô tả việc khách hàng theo dõi tiến độ các yêu cầu thu gom và thực hiện hủy yêu cầu khi cần.
...
**Điều kiện sau:** Khách hàng đã xem thông tin; nếu hủy thì trạng thái yêu cầu là CANCELLED.
...
**Mục đích:** Cho phép khách hàng xem danh sách phần thưởng, kiểm tra điểm và thực hiện đổi thưởng bằng điểm tích lũy.

**Tác nhân, mô tả chung:**
- **Tác nhân:** Khách hàng (Customer).
- **Mô tả chung:** Mô tả việc khách hàng chọn phần thưởng, xác nhận đổi và hệ thống trừ điểm, ghi nhận giao dịch.
...
**Luồng thay thế:** Luồng 4a – Điểm không đủ: Hiển thị "Điểm không đủ", yêu cầu tích thêm điểm. Luồng 4b – Hết hàng: Hiển thị "Phần thưởng đã hết", chọn phần thưởng khác.
...
**Mục đích:** Cho phép nhân viên thực hiện thu gom rác tại địa chỉ khách hàng và xác minh loại rác, khối lượng thực tế.
...
**Mục đích:** Cho phép người dùng (khách hàng, nhân viên) khôi phục mật khẩu khi quên thông qua email xác thực.

**Tác nhân, mô tả chung:**
- **Tác nhân:** Khách vãng lai, Khách hàng, Nhân viên (người dùng đã đăng ký).
- **Mô tả chung:** Mô tả việc người dùng yêu cầu đặt lại mật khẩu, nhận link qua email và thực hiện đổi mật khẩu mới.
...
## UC12 – Thống kê và báo cáo

**Mục đích:** Cho phép nhân viên xem thống kê số lượng yêu cầu, khối lượng rác, hiệu suất thu gom và báo cáo theo thời gian.
...
- **Mô tả chung:** Mô tả việc Admin quản lý toàn bộ tài khoản khách hàng và nhân viên trong hệ thống.
...
| - | 2. Hiển thị danh sách người dùng (khách hàng, nhân viên). |
...
**Luồng thay thế:** Email trùng (khi thêm): Hiển thị lỗi, yêu cầu nhập email khác.

**Các yêu cầu cụ thể:** Không có.

**Điều kiện trước:** Admin đã đăng nhập.

**Điều kiện sau:** Danh sách người dùng đã được cập nhật theo thao tác.
...
**Tác nhân, mô tả chung:**
- **Tác nhân:** Quản trị viên (Admin).
- **Mô tả chung:** Mô tả việc Admin quản lý danh mục phần thưởng và điểm cần để đổi từng phần thưởng.
